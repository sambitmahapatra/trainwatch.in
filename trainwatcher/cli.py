...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="trainwatcher", description="TrainWatcher CLI")
    ...
    add_parser.add_argument("--base-url", help="TrainWatcher Cloud base URL")
    ...
    verify_parser.add_argument("--base-url", help="TrainWatcher Cloud base URL")
    ...
    delete_parser.add_argument("--base-url", help="TrainWatcher Cloud base URL")
    delete_parser.add_argument("--api-key-path", help="Path to credentials JSON")

    subparsers.add_parser("help", help="Show TrainWatcher quick help")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "help":
            show_help()
            return 0
    except TrainWatcherError as exc:
